        ...
        <div class="card card-custom shadow-lg">
            <div class="card-body p-4 p-md-5">
                <div class="text-center mb-4">
                    ...
                    <h3 class="font-heading mt-2">Report a Found Item</h3>
                    <p class="text-muted small">Post details of an item you recovered on campus grounds.</p>
                </div>
                ...
                <form action="create.php" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="e.g., iPhone 13 in Blue Case, Student ID Card" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" rows="4" class="form-control" placeholder="Provide general description without revealing secret ownership indicators (which will be verified via form)..." required></textarea>
                    </div>

                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label"><i class="bi bi-geo-alt me-1"></i> Location Found</label>
                            <input type="text" name="location" class="form-control" placeholder="e.g., Science Lab Bench 4, Auditorium" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label"><i class="bi bi-calendar3 me-1"></i> Date Found</label>
                    ...
                    <div class="d-flex justify-content-between align-items-center pt-3 border-top border-secondary border-opacity-25">
                        ...
                        <button type="submit" class="btn btn-success-custom px-4 py-2">
                            <i class="bi bi-send-fill me-1"></i> Publish Found Post
                        </button>
                    </div>
                </form>
            </div>
